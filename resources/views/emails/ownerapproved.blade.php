    ...
    <tr>
        <td align="center"
            ...
            <p style="margin:0;color:#ffe5e5;font-size:18px;">
                Welcome to the Rentify Owner Community
            </p>
    ...
    <tr>
        <td style="padding:40px;">
            ...
            <p style="font-size:16px;line-height:30px;color:#555;">
                We're delighted to inform you that your application to become an
                <strong>Owner</strong> on <strong>Rentify</strong> has been
                <strong style="color:#d90429;">approved</strong>.
            </p>

            <p style="font-size:16px;line-height:30px;color:#555;">
                You are now officially part of the Rentify Owner Community and can
                start renting out your items to customers.
            </p>
            ...
            <table width="100%"
                ...
                <tr>
                    <td style="padding:20px;">
                        ...
                        <p style="margin:0;color:#555;line-height:30px;">
                            ✔ List rental items<br>
                            ✔ Manage booking requests<br>
                            ✔ Track your rental listings<br>
                            ✔ Connect with renters<br>
                            ✔ Grow your rental business through Rentify
                        </p>
        ...
        <td align="center" style="padding:0 40px 40px;">
            ...
            <div style="background:#f8fafc;border:1px dashed #d90429;border-radius:10px;padding:20px;">
                ...
                <p style="margin:0;color:#666;line-height:28px;">
                    Log in to your account, add your first rental item, and begin
                    earning by sharing your items with thousands of renters on
                    Rentify.
                </p>
