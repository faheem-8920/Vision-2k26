    ...
    <tr>
        <td align="center"
            ...
            <p style="margin:0;color:#ffe5e5;font-size:18px;">
                Update Regarding Your Booking Request
            </p>
    ...
    <tr>
        <td style="padding:40px;">
            ...
            <p style="font-size:16px;line-height:30px;color:#555;">
                Thank you for choosing <strong>Rentify</strong>. We regret to inform you that
                your booking request has been
                <strong style="color:#d90429;">declined</strong> by the owner.
            </p>
                ...
                <tr>
                    <td style="padding:20px;">
                        ...
                        <h3 style="margin-top:0;color:#d90429;">
                            ℹ️ Why Was It Declined?
                        </h3>

                        <p style="margin-bottom:0;color:#555;line-height:28px;">
                            The owner may have been unavailable during your selected rental period,
                            the item may no longer be available, or they were unable to accept the
                            booking request at this time.
                        </p>
        ...
        <td align="center" style="padding:0 40px 40px;">
            ...
            <div style="background:#f8fafc;border:1px dashed #d90429;border-radius:10px;padding:20px;">
                ...
                <p style="margin:0;color:#666;line-height:28px;">
                    Don't worry! Rentify offers many other rental items that may suit your needs.
                    Browse available listings and submit another booking request anytime.
                </p>
